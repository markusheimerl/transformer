...
int main() {
    ...
    CHECK_CUDA(cudaMemcpy(output, loaded_transformer->mlp_layers[loaded_transformer->num_layers - 1]->d_output, batch_size * seq_len * d_model * sizeof(float), cudaMemcpyDeviceToHost));
