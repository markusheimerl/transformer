...
int main() {
    ...
    Transformer* transformer = init_transformer(seq_len, d_model, hidden_dim, num_layers, batch_size, false, false);
    ...
    Transformer* loaded_transformer = deserialize_transformer(model_file, batch_size);
    fclose(model_file);
